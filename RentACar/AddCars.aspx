<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddCars.aspx.cs" Inherits="RentACar.AddCars" %>
                    ...
                    <div class="card-body">
                        <div class="row g-3  mb-3 mt-3">
                            <div class="col-lg-6">
                                ...
                                <div class="col-12 mt-2">
                                    <label class="form-label">Car Image2</label>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-12 mt-2">
                                    <label class="form-label">Car Image3</label>
